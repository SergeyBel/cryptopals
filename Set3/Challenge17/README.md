...
Пусть мы хотим расшифровать блок $C$  шифротекста. Расшифровавыть мы будем побайтово, начиная с последнего байта
...
$$P = B \oplus D_k(C) = B \oplus I$, значит $P[15] = B[15] \oplus I[15]$$   
