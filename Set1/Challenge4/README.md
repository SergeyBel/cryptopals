Задание является небольшим усложнением предыдущего, только вместо дешифровки одного текста нужно найти зашифрованный однобайтовым xor-ом текст среди множества текстов и расшифровать его
